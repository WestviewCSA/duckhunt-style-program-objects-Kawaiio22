...
public class Tracker {
   ...
   private Image oneCarrot;
    ...
    public Tracker() {
        normal = getImage("/imgs/nocarot.png"); // Load the image file
    ...
    public Tracker(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public Tracker(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
