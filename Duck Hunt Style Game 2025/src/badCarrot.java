...
public class badCarrot {
    ...
    public badCarrot() {
        normal = getImage("/imgs/badCarrot.png"); // Load the image file
    ...
    public badCarrot(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public badCarrot(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
...
//        System.out.println("y = " + y + ", vy = " + vy);
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = badCarrot.class.getResource(path);
