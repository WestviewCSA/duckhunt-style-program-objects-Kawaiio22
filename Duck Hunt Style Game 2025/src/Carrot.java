...
public class Carrot {
    ...
    public Carrot(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public Carrot(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
...
//        System.out.println("y = " + y + ", vy = " + vy);
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = Carrot.class.getResource(path);
